...
namespace ScanStoreService.Infrastructure
{
    public partial class ScanStoreContext : DbContext
    {
        ...
        public ScanStoreContext(DbContextOptions options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
#if DEBUG
                optionsBuilder.UseSqlServer("Server=Priserv8074;Database=ScanStoreService;User id=ScanStoreUser;Password=LZ1xGhPVWmRitQmq7FuF;");
#else
                optionsBuilder.UseSqlServer("Server=Priserv8076;Database=IRED;Trusted_Connection=True;");
#endif
            }
        ...
        public virtual DbSet<ContractScansExt> ContractScansExt { get; set; }
        ...
        public virtual DbSet<ContractsFromCessionsAssigment> ContractsFromCessionsAssigment { get; set; }
        ...
        public virtual DbSet<ContractsTempBigint> ContractsTempBigint { get; set; }
        ...
        public virtual DbSet<LogInsContractsFromCessionsAssigment> LogInsContractsFromCessionsAssigment { get; set; }
        ...
        public virtual DbSet<MigrPartners> MigrPartners { get; set; }
        ...
        public virtual DbSet<VwContractFromCessionsOld> VwContractFromCessionsOld { get; set; }
        public virtual DbSet<VwContractLocation> VwContractLocation { get; set; }
        ...
        public virtual DbSet<VwNewPartnerForCession> VwNewPartnerForCession { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=Priserv8074;Database=ScanStore;Trusted_Connection=True;");
            }
        }
        */
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cessions>(entity =>
            {
                ...
                entity.Property(e => e.MigrPartnerId).HasColumnName("migr_partner_id");
            ...
            modelBuilder.Entity<ContractScansExt>(entity =>
            {
                entity.HasKey(e => e.IdDocNrs)
                    .HasName("PK_doc_link_from_nrs");

                entity.ToTable("Contract_scans_ext");

                entity.HasIndex(e => e.IdClient)
                    .HasName("id_client_NonClusteredIndex-20200327-013324");

                entity.HasIndex(e => e.IdNrs)
                    .HasName("id_nrs_NonClusteredIndex-20200327-013135");
            ...
            modelBuilder.Entity<ContractsFromCessionsAssigment>(entity =>
            {
                entity.ToTable("Contracts_From_Cessions_Assigment");
                ...
                entity.HasOne(d => d.Cession)
                    .WithMany(p => p.ContractsFromCessionsAssigment)
                    .HasForeignKey(d => d.CessionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Contracts_From_Cessions_Assigment_Cessions");

                entity.HasOne(d => d.Contract)
                    .WithMany(p => p.ContractsFromCessionsAssigment)
                    .HasForeignKey(d => d.ContractId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Contracts_From_Cessions_Assigment_Contracts");
            });
            ...
            modelBuilder.Entity<ContractsTempBigint>(entity =>
            {
                entity.ToTable("Contracts_temp_bigint");

                entity.HasIndex(e => e.IdHkd)
                    .HasName("NonClusteredColumnStoreIndex-20200205-165042");

                entity.HasIndex(e => e.IdSess)
                    .HasName("NonClusteredIndex-20200205-165315");
            ...
            modelBuilder.Entity<LogInsContractsFromCessionsAssigment>(entity =>
            {
                entity.ToTable("Log_Ins_Contracts_From_Cessions_Assigment");
                ...
                entity.HasOne(d => d.IdTaskNavigation)
                    .WithMany(p => p.LogInsContractsFromCessionsAssigment)
                    .HasForeignKey(d => d.IdTask)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Log_Ins_Contracts_From_Cessions_Assigment_Task");
            });
            ...
            modelBuilder.Entity<MigrPartners>(entity =>
            {
                entity.ToTable("Migr_Partners");
                ...
                entity.HasOne(d => d.Partner)
                    .WithMany(p => p.MigrPartners)
                    .HasForeignKey(d => d.PartnerId)
                    .HasConstraintName("FK_PartnerMigr_Partners");
            });
            ...
            modelBuilder.Entity<VwContractFromCessions>(entity =>
            {
                ...
                entity.Property(e => e.CountScanEtc).HasColumnName("count_scan_ETC");
            ...
            modelBuilder.Entity<VwContractFromCessionsOld>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwContractFromCessions_old");
            ...
            modelBuilder.Entity<VwContractLocation>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwContractLocation");
            ...
            modelBuilder.Entity<VwNewPartnerForCession>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwNewPartnerForCession");
                ...
                entity.Property(e => e.NewPartnerId).HasColumnName("new_partner_id");
